  ...
  return (
    <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
      <div className="group relative">
        {/* Main Footer */}
        <div className="flex flex-col sm:flex-row items-center justify-between bg-gradient-to-r from-purple-50/80 to-blue-50/80 backdrop-blur-sm rounded-lg px-4 sm:px-6 py-3 sm:py-4 cursor-help">
        ...
        <div className="absolute bottom-full left-0 right-0 mb-2 hidden sm:group-hover:block z-10">
          <div className="bg-white border border-purple-200 rounded-lg shadow-lg p-3 sm:p-4 max-w-md mx-auto">
            ...
            <div className="grid grid-cols-2 xs:grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">
        ...
        {/* Mobile Touch Tooltip - Shows on click/tap for mobile */}
