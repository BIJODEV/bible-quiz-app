...
const BibleTimeline = ({ onBack, teamMode, teams, setTeams, currentTeam, setCurrentTeam }) => {
  ...
  const startNewRound = () => {
    ...
    // Sort by actual chronological order (by ID)
    ...
    return (
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Bible Timeline Challenge</h1>
          <p className="text-xl text-gray-600">Arrange Biblical events in chronological order</p>
        </div>
    ...
    return (
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-2xl mx-auto">
        <div className="text-center">
          <div className="text-6xl mb-4">🏆</div>
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Timeline Challenge Complete!</h2>
    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 max-w-4xl mx-auto">
      ...
      {showCorrect && (
        <div className="mb-6 bg-green-50 border-2 border-green-200 rounded-xl p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-green-800 mb-3">Perfect Timeline!</h3>
          
          {/* Points Breakdown */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="bg-white rounded-lg p-3 border border-green-200">
              <div className="text-sm text-gray-600">Base Points</div>
              <div className="text-xl font-bold text-green-600">+{basePoints}</div>
            </div>
            <div className="bg-white rounded-lg p-3 border border-green-200">
              <div className="text-sm text-gray-600">Time Bonus</div>
              <div className="text-xl font-bold text-green-600">+{Math.round(timeBonus)}</div>
            </div>
            <div className="bg-white rounded-lg p-3 border border-green-200">
              <div className="text-sm text-gray-600">Hint Penalty</div>
              <div className="text-xl font-bold text-red-600">-{hintPenalty}</div>
            </div>
          </div>
          ...
          <p className="text-green-600">Moving to next round...</p>
        </div>
      )}

      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-2">Arrange Events Chronologically</h2>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            {!showCorrect && (
              ...
              >
                {showHint ? 'Hide Dates' : 'Show Dates (-25 points)'}
              </button>
            )}
          </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="text-left">
                    ...
                    <p className="text-gray-600 text-sm">{event.reference}</p>
        ...
        {!showCorrect && (
          <div className="mt-6 bg-gray-50 rounded-lg p-4">
            ...
            {teamMode ? (
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="text-center">
                  ...
                  <div className="text-lg">{teams.teamA}</div>
                </div>
                <div className="text-center">
                  <div className="font-bold text-red-600">Team B</div>
                  <div className="text-lg">{teams.teamB}</div>
                </div>
              </div>
            ) : (
              <div className="text-center">
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              <h5 className="font-semibold text-gray-700 mb-1">Scoring This Round:</h5>
